...
// ArrivalTimeService is an autogenerated mock type for the ArrivalTimeService type
type ArrivalTimeService struct {
	mock.Mock
}

// GetArrivalTime provides a mock function with given fields: ctx, point
func (_m *ArrivalTimeService) GetArrivalTime(ctx context.Context, point app.Point) (int64, error) {
